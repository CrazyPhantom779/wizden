...
namespace Content.Shared.Strip.Components
{
    ...
    public sealed partial class StrippableComponent : Component
    {
        ...
        public TimeSpan HandStripDelay = TimeSpan.FromSeconds(2f); // CD: Decreased HandStripDelay for easier transfer of items as it's not needed for antag balancing
    }
