    ...
    IOnSystemChanged<ClientInventorySystem>, IOnSystemChanged<HandsSystem>
{
    ...
    private MenuButton? InventoryButton => UIManager.GetActiveUIWidgetOrNull<MenuBar.Widgets.GameTopMenuBar>()?.InventoryButton; // CD
    ...
    public void ToggleInventoryBar()
    {
        ...
        InventoryButton?.SetClickPressed(shouldBeVisible); // CD
    }
